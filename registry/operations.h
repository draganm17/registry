...
namespace registry
{
    ...
    */
    ...
    /*!
    @param[in]  path - an absolute key path specifying the registry key that this function queries the information
                       about.
    ...
    */
    ...
    @return 
        ...
        The overload that takes `std::error_code&` parameter sets all members to `static_cast<uint32_t>(-1)` on error.
